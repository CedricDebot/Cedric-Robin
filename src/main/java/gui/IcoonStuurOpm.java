...
public class IcoonStuurOpm extends GridPane {
    ...
    public IcoonStuurOpm() {
        ...
        for (AttitudeOpmerking attudeOpm : standaardOpmerkingenList) {
            standaarOpmerkingen.add(attudeOpm.getNaam());
        }
        ...
        opmerkingenList.setOnMouseClicked(event -> {
            ...
            for (AttitudeOpmerking attudeOpm : standaardOpmerkingenList) {
                if (attudeOpm.getNaam().equals(selectedOpmerking2)) {

                    opmerkingVeld.setText(attudeOpm.getOpmerking());
                }
            }
        });
        //voegtoe
